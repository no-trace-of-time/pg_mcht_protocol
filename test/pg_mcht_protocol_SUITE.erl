...
-define(SIGN_FIELD_ORDER, dict_order).
...
qs(collect) ->
  [
    ...
    , {<<"tranTime">>, <<"095817">>}
    , {<<"signature">>,
    case ?SIGN_FIELD_ORDER of
      dict_order ->
        <<"">>;
      _ ->
        <<"">>
    end
  }
    , {<<"certifType">>, <<"01">>}
...
collect_sign_string_test() ->
  ...
  case ?SIGN_FIELD_ORDER of
    dict_order ->
      ?assertEqual(<<"6216261000000000018341126197709218366全渠道0100001测试交易13552535506502017102120171021095817473460847095817http://localhost:8888/pg/simu_mcht_back_succ_info"/utf8>>,
...
collect_sign_test_1() ->
  ...
  case ?SIGN_FIELD_ORDER of
    dict_order ->
      ?assertEqual(<<"">>,
        Sig);
    _ ->
  ...
  case ?SIGN_FIELD_ORDER of
    dict_order ->
      ?assertEqual(<<"">>,
        Sig64);
    _ ->
  ...
  P64 =
    case ?SIGN_FIELD_ORDER of
      dict_order ->
        pg_model:set(M, P,
          [{mcht_id, <<"00002">>},
            {signature, <<"">>}]
        );
      _ ->
        pg_model:set(M, P,
          [{mcht_id, <<"00002">>},
